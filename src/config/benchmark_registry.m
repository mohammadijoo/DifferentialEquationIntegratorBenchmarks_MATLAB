...
benchmarks(end+1) = make_benchmark('SwiftHohenbergEquation', 'Swift-Hohenberg Equation (Fourier Spectral MOL)', @benchmark_swift_hohenberg_equation, 'pde_mol', 'all_first_order', true, 'benchmarks/05_PDE_method_of_lines_and_conservation_laws/SwiftHohenbergEquation.md', 'implemented');
