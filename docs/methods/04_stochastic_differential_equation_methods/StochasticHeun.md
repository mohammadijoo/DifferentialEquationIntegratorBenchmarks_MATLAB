...
Predictor-corrector method for SDEs..
...
```text
Not implemented yet. Suggested future file: src/methods/stochastic_heun.m
```
...
Stochastic Heun should be understood as part of the **Predictor-corrector method for SDEs.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Predictor-corrector method for SDEs..
