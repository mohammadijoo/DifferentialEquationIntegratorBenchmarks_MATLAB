...
Uses a Jacobian linearization and one linear solve per step.
...
Rosenbrock-type methods were introduced to reduce the nonlinear-solve cost of fully implicit Runge-Kutta methods.
...
- Gives a clear benchmark representative of the Linearly implicit method family.
