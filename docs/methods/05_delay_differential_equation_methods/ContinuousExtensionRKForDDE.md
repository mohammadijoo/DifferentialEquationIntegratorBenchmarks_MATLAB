# Continuous-Extension RK for DDEs

## Category

DDE method using continuous Runge-Kutta extensions..
...
```text
Not implemented yet. Suggested future file: src/methods/continuous_extension_rkfor_dde.m
```
...
Continuous-Extension RK for DDEs should be understood as part of the **DDE method using continuous Runge-Kutta extensions.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into DDE method using continuous Runge-Kutta extensions..
