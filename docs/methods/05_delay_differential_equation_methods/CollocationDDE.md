# Collocation DDE Method

## Category

Collocation method for delay equations..
...
```text
Not implemented yet. Suggested future file: src/methods/collocation_dde.m
```
...
Collocation DDE Method should be understood as part of the **Collocation method for delay equations.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Collocation method for delay equations..
