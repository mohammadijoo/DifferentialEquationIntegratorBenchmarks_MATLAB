# Linear Multistep DDE Method

## Category

Multistep integration for delay differential equations..
...
```text
Not implemented yet. Suggested future file: src/methods/linear_multistep_dde.m
```
...
Linear Multistep DDE Method should be understood as part of the **Multistep integration for delay differential equations.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Multistep integration for delay differential equations..
