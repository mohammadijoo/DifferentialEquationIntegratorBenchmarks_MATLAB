# Gear-Gupta-Leimkuhler Method

## Category

Constrained mechanical DAE integration method..
...
```text
Not implemented yet. Suggested future file: src/methods/gear_gupta_leimkuhler.m
```
...
Gear-Gupta-Leimkuhler Method should be understood as part of the **Constrained mechanical DAE integration method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Constrained mechanical DAE integration method..
