...
Structural index-reduction algorithm for high-index DAEs..
...
```text
Not implemented yet. Suggested future file: src/methods/pantelides_index_reduction.m
```
...
Pantelides Index Reduction should be understood as part of the **Structural index-reduction algorithm for high-index DAEs.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Structural index-reduction algorithm for high-index DAEs..
