...
Alternating-direction implicit method family..
...
```text
Not implemented yet. Suggested future file: src/methods/adi.m
```
...
ADI should be understood as part of the **Alternating-direction implicit method family.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Alternating-direction implicit method family..
