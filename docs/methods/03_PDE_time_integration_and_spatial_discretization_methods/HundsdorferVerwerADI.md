...
ADI scheme for multidimensional convection-diffusion-reaction PDEs..
...
```text
Not implemented yet. Suggested future file: src/methods/hundsdorfer_verwer_adi.m
```
...
Hundsdorfer-Verwer ADI should be understood as part of the **ADI scheme for multidimensional convection-diffusion-reaction PDEs.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into ADI scheme for multidimensional convection-diffusion-reaction PDEs..
...
PDEs after suitable spatial discretization and boundary-condition treatment
