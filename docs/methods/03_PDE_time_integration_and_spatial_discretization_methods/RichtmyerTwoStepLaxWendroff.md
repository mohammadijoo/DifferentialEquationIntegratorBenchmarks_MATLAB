...
Two-step version of Lax-Wendroff for hyperbolic systems..
...
```text
Not implemented yet. Suggested future file: src/methods/richtmyer_two_step_lax_wendroff.m
```
...
Richtmyer Two-Step Lax-Wendroff should be understood as part of the **Two-step version of Lax-Wendroff for hyperbolic systems.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Two-step version of Lax-Wendroff for hyperbolic systems..
