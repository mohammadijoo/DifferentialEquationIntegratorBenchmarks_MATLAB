...
Second-order method for hyperbolic PDEs..
...
```text
Not implemented yet. Suggested future file: src/methods/lax_wendroff.m
```
...
Lax-Wendroff should be understood as part of the **Second-order method for hyperbolic PDEs.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Second-order method for hyperbolic PDEs..
