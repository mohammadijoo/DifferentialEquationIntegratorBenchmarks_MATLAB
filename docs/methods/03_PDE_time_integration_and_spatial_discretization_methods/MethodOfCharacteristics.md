...
PDE method following characteristic curves..
...
```text
Not implemented yet. Suggested future file: src/methods/method_of_characteristics.m
```
...
Method of Characteristics should be understood as part of the **PDE method following characteristic curves.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into PDE method following characteristic curves..
