...
Riemann-solver-based finite-volume method..
...
```text
Not implemented yet. Suggested future file: src/methods/godunov_method.m
```
...
Godunov Method should be understood as part of the **Riemann-solver-based finite-volume method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Riemann-solver-based finite-volume method..
