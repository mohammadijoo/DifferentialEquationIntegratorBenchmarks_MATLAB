...
Conservative cell-average method for conservation laws..
...
```text
Not implemented yet. Suggested future file: src/methods/finite_volume_method.m
```
...
Finite Volume Method should be understood as part of the **Conservative cell-average method for conservation laws.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Conservative cell-average method for conservation laws..
