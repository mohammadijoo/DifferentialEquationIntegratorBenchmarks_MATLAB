...
Fourth-order symplectic composition.

## Implemented MATLAB file

```text
src/methods/yoshida4_method.m
```

## Core idea

Fourth-order symplectic composition of second-order steps.
...
Haruo Yoshida developed higher-order symplectic integrators using compositions of lower-order maps in 1990.
...
- Gives a clear benchmark representative of the Fourth-order symplectic composition family.
...
high-accuracy long-time Hamiltonian simulation
