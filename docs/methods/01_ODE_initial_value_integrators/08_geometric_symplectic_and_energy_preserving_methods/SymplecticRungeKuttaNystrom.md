# Symplectic Runge-Kutta-Nyström

## Category

Direct second-order symplectic method family..
...
```text
Not implemented yet. Suggested future file: src/methods/symplectic_runge_kutta_nystrom.m
```
...
Symplectic Runge-Kutta-Nyström should be understood as part of the **Direct second-order symplectic method family.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Direct second-order symplectic method family..
