...
Energy-preserving method based on averaged vector fields..
...
```text
Not implemented yet. Suggested future file: src/methods/average_vector_field.m
```
...
Average Vector Field Method should be understood as part of the **Energy-preserving method based on averaged vector fields.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Energy-preserving method based on averaged vector fields..
