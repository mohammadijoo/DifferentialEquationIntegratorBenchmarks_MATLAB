...
Lie-group integrator using Lie algebra coordinates..
...
```text
Not implemented yet. Suggested future file: src/methods/runge_kutta_munthe_kaas.m
```
...
Runge-Kutta-Munthe-Kaas should be understood as part of the **Lie-group integrator using Lie algebra coordinates.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Lie-group integrator using Lie algebra coordinates..
