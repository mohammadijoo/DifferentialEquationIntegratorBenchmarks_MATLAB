# General Discrete Gradient Method

## Category

Energy-preserving discrete-gradient method beyond oscillator examples..
...
```text
Not implemented yet. Suggested future file: src/methods/general_discrete_gradient.m
```
...
General Discrete Gradient Method should be understood as part of the **Energy-preserving discrete-gradient method beyond oscillator examples.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Energy-preserving discrete-gradient method beyond oscillator examples..
