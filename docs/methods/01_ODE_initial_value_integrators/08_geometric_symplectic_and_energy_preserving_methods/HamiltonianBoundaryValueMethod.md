...
```text
Not implemented yet. Suggested future file: src/methods/hamiltonian_boundary_value_method.m
```
...
Hamiltonian Boundary Value Method should be understood as part of the **Energy-preserving HBVM family.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Energy-preserving HBVM family..
