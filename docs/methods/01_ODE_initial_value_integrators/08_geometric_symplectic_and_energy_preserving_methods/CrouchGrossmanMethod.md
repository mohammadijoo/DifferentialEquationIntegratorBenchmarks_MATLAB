...
Runge-Kutta-like method on Lie groups..
...
```text
Not implemented yet. Suggested future file: src/methods/crouch_grossman_method.m
```
...
Crouch-Grossman Method should be understood as part of the **Runge-Kutta-like method on Lie groups.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Runge-Kutta-like method on Lie groups..
