...
Method preserving discrete energy/momentum structures..
...
```text
Not implemented yet. Suggested future file: src/methods/energy_momentum_method.m
```
...
Energy-Momentum Method should be understood as part of the **Method preserving discrete energy/momentum structures.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Method preserving discrete energy/momentum structures..
