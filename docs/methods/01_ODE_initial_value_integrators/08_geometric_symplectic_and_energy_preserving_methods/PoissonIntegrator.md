...
Structure-preserving method for Poisson systems..
...
```text
Not implemented yet. Suggested future file: src/methods/poisson_integrator.m
```
...
Poisson Integrator should be understood as part of the **Structure-preserving method for Poisson systems.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Structure-preserving method for Poisson systems..
