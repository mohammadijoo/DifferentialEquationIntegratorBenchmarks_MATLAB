# Projection-to-Invariant Method

## Category

Post-step projection enforcing invariants..
...
```text
Not implemented yet. Suggested future file: src/methods/projection_to_invariant.m
```
...
Projection-to-Invariant Method should be understood as part of the **Post-step projection enforcing invariants.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Post-step projection enforcing invariants..
