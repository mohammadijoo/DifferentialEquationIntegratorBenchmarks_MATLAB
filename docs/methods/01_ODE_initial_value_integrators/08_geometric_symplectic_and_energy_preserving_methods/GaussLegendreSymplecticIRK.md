# Gauss-Legendre Symplectic IRK

## Category

High-order symplectic implicit Runge-Kutta collocation method..
...
```text
Not implemented yet. Suggested future file: src/methods/gauss_legendre_symplectic_irk.m
```
...
Gauss-Legendre Symplectic IRK should be understood as part of the **High-order symplectic implicit Runge-Kutta collocation method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into High-order symplectic implicit Runge-Kutta collocation method..
