...
Adaptive-step controller using proportional-integral-derivative error history..
...
```text
Not implemented yet. Suggested future file: src/methods/pidstep_size_controller.m
```
...
PID Step-Size Controller should be understood as part of the **Adaptive-step controller using proportional-integral-derivative error history.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Adaptive-step controller using proportional-integral-derivative error history..
