# Event and Root Finding

## Category

Detection and localization of event surfaces during integration..
...
```text
Not implemented yet. Suggested future file: src/methods/event_root_finding.m
```
...
Event and Root Finding should be understood as part of the **Detection and localization of event surfaces during integration.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Detection and localization of event surfaces during integration..
