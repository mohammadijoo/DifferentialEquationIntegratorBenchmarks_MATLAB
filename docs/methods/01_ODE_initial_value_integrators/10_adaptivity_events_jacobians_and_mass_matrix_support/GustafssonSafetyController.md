# Gustafsson Safety Controller

## Category

Adaptive-step control strategy reducing repeated step rejection..
...
```text
Not implemented yet. Suggested future file: src/methods/gustafsson_safety_controller.m
```
...
Gustafsson Safety Controller should be understood as part of the **Adaptive-step control strategy reducing repeated step rejection.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Adaptive-step control strategy reducing repeated step rejection..
