...
Second-order method with controllable high-frequency dissipation..
...
```text
Not implemented yet. Suggested future file: src/methods/generalized_alpha.m
```
...
Generalized-alpha Method should be understood as part of the **Second-order method with controllable high-frequency dissipation.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Second-order method with controllable high-frequency dissipation..
