...
Newmark-type structural dynamics method..
...
```text
Not implemented yet. Suggested future file: src/methods/linear_acceleration_method.m
```
...
Linear Acceleration Method should be understood as part of the **Newmark-type structural dynamics method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Newmark-type structural dynamics method..
