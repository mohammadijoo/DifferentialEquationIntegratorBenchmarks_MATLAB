...
Implicit multistep structural dynamics method..
...
```text
Not implemented yet. Suggested future file: src/methods/houbolt_method.m
```
...
Houbolt Method should be understood as part of the **Implicit multistep structural dynamics method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Implicit multistep structural dynamics method..
