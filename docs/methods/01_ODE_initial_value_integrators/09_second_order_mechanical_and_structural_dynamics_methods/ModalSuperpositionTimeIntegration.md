...
Time integration using modal decomposition of linear systems..
...
```text
Not implemented yet. Suggested future file: src/methods/modal_superposition_time_integration.m
```
...
Modal Superposition Time Integration should be understood as part of the **Time integration using modal decomposition of linear systems.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Time integration using modal decomposition of linear systems..
