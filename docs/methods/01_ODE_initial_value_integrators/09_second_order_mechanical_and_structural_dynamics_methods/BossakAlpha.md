...
Alpha-family variant for structural dynamics..
...
```text
Not implemented yet. Suggested future file: src/methods/bossak_alpha.m
```
...
Bossak-alpha Method should be understood as part of the **Alpha-family variant for structural dynamics.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Alpha-family variant for structural dynamics..
