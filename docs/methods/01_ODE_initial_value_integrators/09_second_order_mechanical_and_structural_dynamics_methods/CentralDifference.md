...
Explicit second-order structural dynamics method..
...
```text
Not implemented yet. Suggested future file: src/methods/central_difference.m
```
...
Central Difference Method should be understood as part of the **Explicit second-order structural dynamics method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Explicit second-order structural dynamics method..
