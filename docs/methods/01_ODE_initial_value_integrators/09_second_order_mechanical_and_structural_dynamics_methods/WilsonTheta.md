...
Implicit structural dynamics method with theta parameter..
...
```text
Not implemented yet. Suggested future file: src/methods/wilson_theta.m
```
...
Wilson-theta Method should be understood as part of the **Implicit structural dynamics method with theta parameter.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Implicit structural dynamics method with theta parameter..
