...
A-stable Lobatto collocation family for stiff and DAE problems..
...
```text
Not implemented yet. Suggested future file: src/methods/lobatto_iiic.m
```
...
Lobatto IIIC should be understood as part of the **A-stable Lobatto collocation family for stiff and DAE problems.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into A-stable Lobatto collocation family for stiff and DAE problems..
