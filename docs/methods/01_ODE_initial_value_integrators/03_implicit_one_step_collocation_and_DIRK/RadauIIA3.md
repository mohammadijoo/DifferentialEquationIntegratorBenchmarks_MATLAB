...
Stiffly accurate implicit Runge-Kutta collocation method..
...
```text
Not implemented yet. Suggested future file: src/methods/radau_iia3.m
```
...
Radau IIA 3rd Order should be understood as part of the **Stiffly accurate implicit Runge-Kutta collocation method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Stiffly accurate implicit Runge-Kutta collocation method..
