# Gauss-Legendre IRK 2nd Order

## Category

A-stable symplectic collocation method..
...
```text
Not implemented yet. Suggested future file: src/methods/gauss_legendre_irk2.m
```
...
Gauss-Legendre IRK 2nd Order should be understood as part of the **A-stable symplectic collocation method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into A-stable symplectic collocation method..
