...
Fifth-order Radau IIA stiff implicit Runge-Kutta method..
...
```text
Not implemented yet. Suggested future file: src/methods/radau_iia5.m
```
...
Radau IIA 5th Order should be understood as part of the **Fifth-order Radau IIA stiff implicit Runge-Kutta method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Fifth-order Radau IIA stiff implicit Runge-Kutta method..
