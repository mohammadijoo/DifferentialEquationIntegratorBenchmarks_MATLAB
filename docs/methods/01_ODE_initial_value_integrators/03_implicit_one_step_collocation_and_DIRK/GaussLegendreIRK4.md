# Gauss-Legendre IRK 4th Order

## Category

Fourth-order symplectic implicit Runge-Kutta collocation method..
...
```text
Not implemented yet. Suggested future file: src/methods/gauss_legendre_irk4.m
```
...
Gauss-Legendre IRK 4th Order should be understood as part of the **Fourth-order symplectic implicit Runge-Kutta collocation method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Fourth-order symplectic implicit Runge-Kutta collocation method..
