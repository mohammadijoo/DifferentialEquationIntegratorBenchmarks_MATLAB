...
Singly diagonally implicit Runge-Kutta method family..
...
```text
Not implemented yet. Suggested future file: src/methods/sdirk.m
```
...
SDIRK should be understood as part of the **Singly diagonally implicit Runge-Kutta method family.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Singly diagonally implicit Runge-Kutta method family..
