...
Diagonally implicit Runge-Kutta method family..
...
```text
Not implemented yet. Suggested future file: src/methods/dirk.m
```
...
DIRK should be understood as part of the **Diagonally implicit Runge-Kutta method family.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Diagonally implicit Runge-Kutta method family..
