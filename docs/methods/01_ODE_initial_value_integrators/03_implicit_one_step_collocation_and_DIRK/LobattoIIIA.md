...
Implicit collocation method useful for boundary and DAE formulations..
...
```text
Not implemented yet. Suggested future file: src/methods/lobatto_iiia.m
```
...
Lobatto IIIA should be understood as part of the **Implicit collocation method useful for boundary and DAE formulations.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Implicit collocation method useful for boundary and DAE formulations..
