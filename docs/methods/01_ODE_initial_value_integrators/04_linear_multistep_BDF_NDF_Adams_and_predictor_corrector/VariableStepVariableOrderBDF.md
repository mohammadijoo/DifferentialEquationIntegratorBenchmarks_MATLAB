...
Production-style BDF solver with step and order adaptation..
...
```text
Not implemented yet. Suggested future file: src/methods/variable_step_variable_order_bdf.m
```
...
- Extends the benchmark coverage into Production-style BDF solver with step and order adaptation..
