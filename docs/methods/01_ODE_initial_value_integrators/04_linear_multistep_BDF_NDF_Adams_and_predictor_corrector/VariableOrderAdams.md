# Variable-Order Adams

## Category

Adaptive-order Adams predictor-corrector solver family..
...
```text
Not implemented yet. Suggested future file: src/methods/variable_order_adams.m
```
...
Variable-Order Adams should be understood as part of the **Adaptive-order Adams predictor-corrector solver family.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Adaptive-order Adams predictor-corrector solver family..
