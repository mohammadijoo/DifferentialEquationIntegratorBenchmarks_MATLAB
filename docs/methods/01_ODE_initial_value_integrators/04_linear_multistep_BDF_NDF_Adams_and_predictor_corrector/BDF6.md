...
Sixth-order backward differentiation formula..
...
```text
Not implemented yet. Suggested future file: src/methods/bdf6.m
```
...
BDF6 should be understood as part of the **Sixth-order backward differentiation formula.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Sixth-order backward differentiation formula..
