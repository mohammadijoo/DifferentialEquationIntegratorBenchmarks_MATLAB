# Higher-Order Adams-Moulton

## Category

Implicit Adams-Moulton formulas beyond order 2..
...
```text
Not implemented yet. Suggested future file: src/methods/adams_moulton_higher_order.m
```
...
Higher-Order Adams-Moulton should be understood as part of the **Implicit Adams-Moulton formulas beyond order 2.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Implicit Adams-Moulton formulas beyond order 2..
