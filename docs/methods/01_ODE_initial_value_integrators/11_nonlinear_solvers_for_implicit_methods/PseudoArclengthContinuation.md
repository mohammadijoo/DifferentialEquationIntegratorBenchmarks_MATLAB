...
Continuation method for folds and bifurcation branches..
...
```text
Not implemented yet. Suggested future file: src/methods/pseudo_arclength_continuation.m
```
...
Pseudo-Arclength Continuation should be understood as part of the **Continuation method for folds and bifurcation branches.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Continuation method for folds and bifurcation branches..
