...
Full approximation scheme for nonlinear PDE systems..
...
```text
Not implemented yet. Suggested future file: src/methods/fasnonlinear_multigrid.m
```
...
FAS Nonlinear Multigrid should be understood as part of the **Full approximation scheme for nonlinear PDE systems.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Full approximation scheme for nonlinear PDE systems..
