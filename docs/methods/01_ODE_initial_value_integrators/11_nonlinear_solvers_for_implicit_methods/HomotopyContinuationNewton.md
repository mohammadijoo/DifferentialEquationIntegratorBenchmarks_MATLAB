...
Continuation-assisted nonlinear solve..
...
```text
Not implemented yet. Suggested future file: src/methods/homotopy_continuation_newton.m
```
...
Homotopy / Continuation Newton should be understood as part of the **Continuation-assisted nonlinear solve.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Continuation-assisted nonlinear solve..
