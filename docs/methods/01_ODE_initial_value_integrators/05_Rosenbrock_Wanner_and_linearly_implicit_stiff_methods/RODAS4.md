...
Fourth-order Rosenbrock-Wanner method for stiff systems..
...
```text
Not implemented yet. Suggested future file: src/methods/rodas4.m
```
...
RODAS4 should be understood as part of the **Fourth-order Rosenbrock-Wanner method for stiff systems.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Fourth-order Rosenbrock-Wanner method for stiff systems..
