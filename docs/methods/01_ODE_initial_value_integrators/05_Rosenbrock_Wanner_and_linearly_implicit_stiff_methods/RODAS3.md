...
Third-order Rosenbrock-Wanner method with stiff accuracy features..
...
```text
Not implemented yet. Suggested future file: src/methods/rodas3.m
```
...
RODAS3 should be understood as part of the **Third-order Rosenbrock-Wanner method with stiff accuracy features.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Third-order Rosenbrock-Wanner method with stiff accuracy features..
