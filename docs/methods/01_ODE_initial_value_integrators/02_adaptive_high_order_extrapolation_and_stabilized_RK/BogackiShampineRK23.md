...
Embedded Runge-Kutta 2(3) method used in ode23-style solvers..
...
```text
Not implemented yet. Suggested future file: src/methods/bogacki_shampine_rk23.m
```
...
Bogacki-Shampine RK23 should be understood as part of the **Embedded Runge-Kutta 2(3) method used in ode23-style solvers.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Embedded Runge-Kutta 2(3) method used in ode23-style solvers..
