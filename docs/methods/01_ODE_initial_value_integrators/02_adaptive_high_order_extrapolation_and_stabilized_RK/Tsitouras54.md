...
Efficient embedded fifth-order Runge-Kutta method..
...
```text
Not implemented yet. Suggested future file: src/methods/tsitouras54.m
```
...
Tsitouras 5/4 RK should be understood as part of the **Efficient embedded fifth-order Runge-Kutta method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Efficient embedded fifth-order Runge-Kutta method..
