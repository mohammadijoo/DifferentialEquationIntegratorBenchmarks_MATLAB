...
Runge-Kutta-Chebyshev stabilized explicit method..
...
```text
Not implemented yet. Suggested future file: src/methods/rkc.m
```
...
RKC should be understood as part of the **Runge-Kutta-Chebyshev stabilized explicit method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Runge-Kutta-Chebyshev stabilized explicit method..
