...
Eighth-order explicit Runge-Kutta method..
...
```text
Not implemented yet. Suggested future file: src/methods/rk8.m
```
...
RK8 should be understood as part of the **Eighth-order explicit Runge-Kutta method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Eighth-order explicit Runge-Kutta method..
