...
High-order embedded Runge-Kutta-Fehlberg method..
...
```text
Not implemented yet. Suggested future file: src/methods/fehlberg78.m
```
...
Fehlberg 7/8 should be understood as part of the **High-order embedded Runge-Kutta-Fehlberg method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into High-order embedded Runge-Kutta-Fehlberg method..
