...
Orthogonal-polynomial stabilized explicit method..
...
```text
Not implemented yet. Suggested future file: src/methods/rock.m
```
...
ROCK should be understood as part of the **Orthogonal-polynomial stabilized explicit method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Orthogonal-polynomial stabilized explicit method..
