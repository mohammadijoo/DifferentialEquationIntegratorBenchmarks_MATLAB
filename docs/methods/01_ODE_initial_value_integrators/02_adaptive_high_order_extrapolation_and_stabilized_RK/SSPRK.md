...
Strong-stability-preserving Runge-Kutta family..
...
```text
Not implemented yet. Suggested future file: src/methods/ssprk.m
```
...
SSP Runge-Kutta should be understood as part of the **Strong-stability-preserving Runge-Kutta family.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Strong-stability-preserving Runge-Kutta family..
