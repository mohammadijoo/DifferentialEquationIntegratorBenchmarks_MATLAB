# Verner Runge-Kutta Methods

## Category

High-order embedded explicit Runge-Kutta family..
...
```text
Not implemented yet. Suggested future file: src/methods/verner_rk.m
```
...
Verner Runge-Kutta Methods should be understood as part of the **High-order embedded explicit Runge-Kutta family.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into High-order embedded explicit Runge-Kutta family..
