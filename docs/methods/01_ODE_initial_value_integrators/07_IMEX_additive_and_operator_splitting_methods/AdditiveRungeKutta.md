# Additive Runge-Kutta / ARK

## Category

Additively partitioned Runge-Kutta methods..
...
```text
Not implemented yet. Suggested future file: src/methods/additive_runge_kutta.m
```
...
Additive Runge-Kutta / ARK should be understood as part of the **Additively partitioned Runge-Kutta methods.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Additively partitioned Runge-Kutta methods..
