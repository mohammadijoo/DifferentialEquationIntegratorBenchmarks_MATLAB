...
Second-order additive Runge-Kutta method..
...
```text
Not implemented yet. Suggested future file: src/methods/ark2.m
```
...
ARK2 should be understood as part of the **Second-order additive Runge-Kutta method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Second-order additive Runge-Kutta method..
