...
Semi-implicit BDF method for split PDE systems..
...
```text
Not implemented yet. Suggested future file: src/methods/sbdf.m
```
...
Semi-Implicit BDF should be understood as part of the **Semi-implicit BDF method for split PDE systems.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Semi-implicit BDF method for split PDE systems..
