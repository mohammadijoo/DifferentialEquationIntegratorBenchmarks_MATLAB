...
```text
Not implemented yet. Suggested future file: src/methods/chorin_projection.m
```
...
Chorin Projection Method should be understood as part of the **Projection method for incompressible Navier-Stokes.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Projection method for incompressible Navier-Stokes..
