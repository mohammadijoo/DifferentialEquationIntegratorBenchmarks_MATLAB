...
```text
Not implemented yet. Suggested future file: src/methods/tfqmr.m
```
...
TFQMR should be understood as part of the **Transpose-free quasi-minimal residual method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Transpose-free quasi-minimal residual method..
