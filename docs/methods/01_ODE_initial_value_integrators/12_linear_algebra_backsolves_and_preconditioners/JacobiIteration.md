...
Basic stationary linear iteration..
...
```text
Not implemented yet. Suggested future file: src/methods/jacobi_iteration.m
```
...
Jacobi Iteration should be understood as part of the **Basic stationary linear iteration.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Basic stationary linear iteration..
