...
```text
Not implemented yet. Suggested future file: src/methods/sor.m
```
...
Successive Over-Relaxation should be understood as part of the **Relaxed Gauss-Seidel iteration.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Relaxed Gauss-Seidel iteration..
