...
```text
Not implemented yet. Suggested future file: src/methods/conjugate_gradient.m
```
...
Conjugate Gradient should be understood as part of the **Krylov method for symmetric positive definite systems.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Krylov method for symmetric positive definite systems..
