...
Direct solve exploiting banded Jacobian structure..
...
```text
Not implemented yet. Suggested future file: src/methods/banded_lu.m
```
...
Banded LU Factorization should be understood as part of the **Direct solve exploiting banded Jacobian structure.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Direct solve exploiting banded Jacobian structure..
