...
Fifth-order exponential Rosenbrock method..
...
```text
Not implemented yet. Suggested future file: src/methods/exprb53.m
```
...
exprb53 should be understood as part of the **Fifth-order exponential Rosenbrock method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Fifth-order exponential Rosenbrock method..
