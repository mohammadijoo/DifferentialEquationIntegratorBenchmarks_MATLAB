...
```text
Not implemented yet. Suggested future file: src/methods/lawson_method.m
```
...
Lawson Method should be understood as part of the **Integrating-factor Runge-Kutta method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Integrating-factor Runge-Kutta method..
