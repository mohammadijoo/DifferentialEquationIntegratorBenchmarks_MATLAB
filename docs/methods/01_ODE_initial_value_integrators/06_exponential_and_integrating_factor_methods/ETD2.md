...
Second-order exponential time-differencing method..
...
```text
Not implemented yet. Suggested future file: src/methods/etd2.m
```
...
ETD2 should be understood as part of the **Second-order exponential time-differencing method.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Second-order exponential time-differencing method..
