# Integrating Factor Runge-Kutta

## Category

Runge-Kutta method in integrating-factor variables..
...
```text
Not implemented yet. Suggested future file: src/methods/integrating_factor_rk.m
```
...
Integrating Factor Runge-Kutta should be understood as part of the **Runge-Kutta method in integrating-factor variables.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Runge-Kutta method in integrating-factor variables..
