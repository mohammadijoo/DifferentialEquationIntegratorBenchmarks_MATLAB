...
Exponential integrator using Krylov approximation of matrix functions..
...
```text
Not implemented yet. Suggested future file: src/methods/krylov_exponential_integrator.m
```
...
Krylov Exponential Integrator should be understood as part of the **Exponential integrator using Krylov approximation of matrix functions.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Exponential integrator using Krylov approximation of matrix functions..
