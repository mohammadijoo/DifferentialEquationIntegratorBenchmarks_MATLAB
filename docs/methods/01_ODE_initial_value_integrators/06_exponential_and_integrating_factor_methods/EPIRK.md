...
Exponential propagation iterative Runge-Kutta family..
...
```text
Not implemented yet. Suggested future file: src/methods/epirk.m
```
...
EPIRK Methods should be understood as part of the **Exponential propagation iterative Runge-Kutta family.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Exponential propagation iterative Runge-Kutta family..
