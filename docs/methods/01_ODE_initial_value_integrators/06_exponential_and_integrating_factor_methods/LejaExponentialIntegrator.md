# Leja Exponential Integrator

## Category

Exponential integrator using Leja interpolation..
...
```text
Not implemented yet. Suggested future file: src/methods/leja_exponential_integrator.m
```
...
Leja Exponential Integrator should be understood as part of the **Exponential integrator using Leja interpolation.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Exponential integrator using Leja interpolation..
