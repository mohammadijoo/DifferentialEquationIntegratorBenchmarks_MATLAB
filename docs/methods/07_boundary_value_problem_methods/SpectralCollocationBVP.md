# Spectral Collocation BVP

## Category

High-order collocation method using spectral bases..
...
```text
Not implemented yet. Suggested future file: src/methods/spectral_collocation_bvp.m
```
...
Spectral Collocation BVP should be understood as part of the **High-order collocation method using spectral bases.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into High-order collocation method using spectral bases..
