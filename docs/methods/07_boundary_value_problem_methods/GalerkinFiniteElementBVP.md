# Galerkin Finite-Element BVP

## Category

Weak-form finite-element method for BVPs..
...
```text
Not implemented yet. Suggested future file: src/methods/galerkin_finite_element_bvp.m
```
...
Galerkin Finite-Element BVP should be understood as part of the **Weak-form finite-element method for BVPs.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Weak-form finite-element method for BVPs..
