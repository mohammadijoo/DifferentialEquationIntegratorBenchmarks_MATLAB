# Collocation BVP Method

## Category

Polynomial collocation for boundary-value problems..
...
```text
Not implemented yet. Suggested future file: src/methods/collocation_bvp.m
```
...
Collocation BVP Method should be understood as part of the **Polynomial collocation for boundary-value problems.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Polynomial collocation for boundary-value problems..
