...
Second-order, A-stable, symplectic for Hamiltonian systems.
...
The midpoint quadrature idea is classical; the implicit midpoint rule is also a one-stage Gauss collocation method.
...
- Gives a clear benchmark representative of the Implicit Runge-Kutta method family.
...
Hamiltonian mechanics, moderately stiff smooth systems
