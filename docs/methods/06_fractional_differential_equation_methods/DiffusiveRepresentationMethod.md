# Diffusive Representation Method

## Category

Approximation of fractional operators by auxiliary ODEs..
...
```text
Not implemented yet. Suggested future file: src/methods/diffusive_representation_method.m
```
...
Diffusive Representation Method should be understood as part of the **Approximation of fractional operators by auxiliary ODEs.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Approximation of fractional operators by auxiliary ODEs..
