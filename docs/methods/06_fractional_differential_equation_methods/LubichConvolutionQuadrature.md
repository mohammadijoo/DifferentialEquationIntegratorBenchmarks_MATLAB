...
Convolution quadrature for fractional and memory equations..
...
```text
Not implemented yet. Suggested future file: src/methods/lubich_convolution_quadrature.m
```
...
Lubich Convolution Quadrature should be understood as part of the **Convolution quadrature for fractional and memory equations.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Convolution quadrature for fractional and memory equations..
