# L1 Scheme for Caputo Derivatives

## Category

Common first-order scheme for Caputo fractional derivatives..
...
```text
Not implemented yet. Suggested future file: src/methods/l1_caputo_scheme.m
```
...
L1 Scheme for Caputo Derivatives should be understood as part of the **Common first-order scheme for Caputo fractional derivatives.** class. In a benchmark suite, its purpose is not only to produce a trajectory, but also to expose how this class behaves with respect to stability, accuracy, robustness, and computational work.
...
- Extends the benchmark coverage into Common first-order scheme for Caputo fractional derivatives..
